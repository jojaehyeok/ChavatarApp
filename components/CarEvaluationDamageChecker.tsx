...
// 원래도 한 줄에 하나씩이라 넓힐 필요가 없고, 오히려 경계선(Y_SPLIT)이 그 라벨/바
// 그래픽에 너무 가까우면 잘려 보임. y=2280(라디에이터서포트·프런트패널 라벨이 완전히
// 끝나는 지점 뒤)으로 내리고, 그만큼 위쪽 구간에 포함되는 원 개수(TOP_COUNT)도 21로 맞춤.
const Y_SPLIT = 2280;
